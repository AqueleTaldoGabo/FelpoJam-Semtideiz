...
const SAIR = preload("res://Source/Assets/Sprites/Menu Opções sair ligado2.png")
const NORMAL = preload("res://Source/Assets/Sprites/Menu Opções sair desigado2.png")
